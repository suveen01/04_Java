...
//		-> double result1 = a1 + b1; (o)
		double result1 = a1 + b1;
		System.out.println("result1 : " + result1);
		
		
		
//		문자형에 저장된 값은 정수가 맞는지 확인 + 자동형변환
		System.out.println("--------------------");
...
//		-> 값의 범위로 생각 X , 컴퓨터 값 처리 원칙 생각 O 
		...
		int b3 = 2;
		// int  / int = int(값 처리 원칙)
		int result3 = a3 / b3; // 3/2 = 1.5(double) -> 결과값은 1로 나타남
		System.out.println("result3 : " + result3);
//		왜 결과가 1.5가 아니라 1???
//		-> 값 처리 원칙에 의해서 
//		-> int/int의 결과는 무조건 int가 되어야하기 때문에 컴파일러가 1.5(double)을 1(int)로 자동 형변환
