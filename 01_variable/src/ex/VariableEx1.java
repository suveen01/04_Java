...
public class VariableEx1 {
	...
	public static void main(String [] args) {
		 ...
		 * 		* java는 JS와 다르게 처음부터 변수의 자료형을 지정해야된다!
		 * 
		 *  * 1byte = 8bit 
		 *  -> 컴퓨터가 데이터처리(연산)를 위한 최소 단위
		 * 
		 * [Java 기본 자료형 8가지 - 반드시 암기]
		 * - 논리형
...
//			The local variable num1 may not have been initialized => 지역변수 num1이 초기화되지 않음
//		System.out.println(num1);
		...
		if(bool1 &&!bool2) {
			System.out.println("이거 출력 될까"); // true + true = true
		}
...
//		2147483648 <- 일반 정수 표기법 == int 로 인식됨
		long longNum1 = 2147483648L;
		long longNum2 = 30_000_000_000L;  //자릿수 구분을 위해 _ 사용 가능 -> 연산 시 인식x
...
//		floatNum : 1.1234568   -> float는 소수점 아래 8번째 자리에서 반올림
//		doubleNum : 1.123456789 -> double은 소수점 아래 16번째 자리에서 반올림
//		-> 소수점 아래를 더 많이 표현
...
//		문자형이지만 정수형으로도 취급한다!!
		char ch1 = 'A'; // 대문자 'A'를 나타내는 유니코드 65('\u0041')가 저장됨
		char ch2 = '가';
		char ch3 = '全';
		char ch4 = '★';
