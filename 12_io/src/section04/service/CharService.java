...
"""; 
			...
			fw = new FileWriter(folder + "/" + "희망이있다.txt");
			
			// 문자 기반 스트림을 이용해서 출력하기
			fw.write(content); // String, char[] 출력을 위한 기능이 제공됨
			
			// 스트림에 남은 데이터를 밀어냄
			fw.flush(); // close() 시 자동 수행됨(굳이 안 써도 됨)
...
"""; 
			...
			// 문자 기반 파일 출력 스트림 객체 생성
			fw = new FileWriter(folder + "/" + "희망이있다_buffer.txt");
			...
			// 스트림에 남은 데이터를 밀어냄
			bw.flush(); // close() 시 자동 수행됨(굳이 안 써도 됨)
	...
	public void fileInput() {
		 ...
		 * 	 자동으로 수행하도록 만드는 구문
		 */
		String path = "io_test/char/희망이있다.txt";
	...
	public void KeyboardInput() {
		...
		// System.in : 기본 장치(키보드)와 연결된 InputStrem 반환
