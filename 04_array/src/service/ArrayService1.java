...
public class ArrayService1 {
	...
	public void method1() {
		...
		// (참고)
		int num; 
		// int 자료형을 저장하기 위한 공간(변수)을 메모리에 할당하고 이 공간의 이름을 "num"이라고 지정
		// -> 실제 정수 값을 저장 가능(실제 값을 저장할 수 있는 자료형은 기본자료형 밖에 없다)
		...
		// arr = new int[4];
		// -> Heap 메모리 영역에 생성된 int 4칸짜리 배열의 시작 주소를 arr 참조형 변수에 대입
	...
	public void method4() {
		...
		arr[3] = input;
//		 ArrayIndexOutOfBoundsException: Index 3 out of bounds for length 3 => 배열 인덱스 범위 초과 예외
//		-> Java 배열은 존재하지 않은 index를 썼을 때 Js와 달리 늘어나지 않는다. (접근 불가)
